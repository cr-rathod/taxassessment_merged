           ...
           <form class="wizard-form" id="example-advanced-form" action="#">
                                ...
                                <fieldset>
                                  ...
                                  <div class="form-group row">
                                    <div className="col-1-md-1 mt-1  ml-4">
                                      {/* <div className="form-group"> */}
                                      <label  for="userName-2" class="block">Zone No:</label>
                                ...
                                <fieldset>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div className="col-md-2  ml-2">
                                      <div className="form-group">
                                        {/* <label>*Group</label> */}
                                        <label for="userName-2" class="block">Group *</label>
                                ...
                                <fieldset>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div className="col-md-2 mt-2 ml-2">
                                      <div className="form-group">
                                        <label>Is Combine<br/>Property</label>
                                        <select
                                          className="form-control"
                          ...
                          > */}
                                    ...
                                    <div className="row">
                                      ...
                                      <div className="col-md-3 mt-1  ml-2">
                                      <div className="form-group">
                                        <label>भोगवटधाराचे पूर्ण नाव (OP)</label>
                                        <input
                                          className="form-control"
                                          type="text"
                                          value={भोगवटधाराचे}
