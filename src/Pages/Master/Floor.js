                                                ...
                                                <div className="row">
                                                    <div className="col-md-12">
                                                        <ul class="nav nav-tabs md-tabs" role="tablist">
                                                            <li class="nav-item">
                                                                <a class="nav-link active" data-toggle="tab" href="#newFloor" role="tab">New Floor Info</a>
                                                                <div class="slide"></div>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" data-toggle="tab" href="#oldFloor" role="tab">Old Floor Info</a>
                                                                <div class="slide"></div>
                                                            </li>
                                                        </ul>
                                                        <div class="tab-content card-block">
                                                            <div class="tab-pane active" id="newFloor" role="tabpanel">
                                                                <div className="col-sm-12">
                                                                    <div className="card">
                                                                        <div className="card-header">
                                                                            <h5>New Floor</h5>
                                                                        ...
                                                                        <div className="card-block">
                                                                            <form id="main" method="post" action="/" novalidate="">
                                                                                <div className="form-group row">
                                                                                    <label className="col-sm-2 col-form-label">Floor Name</label>
                                                                                    <div className="col-sm-3">
                                                                                        <input type="text" className="form-control" id="newFloorName"
                                                            ...
                                                            <div class="tab-pane" id="oldFloor" role="tabpanel">
                                                                <div className="col-sm-12">
                                                                    <div className="card">
                                                                        <div className="card-header">
                                                                            <h5>Old Floor</h5>
                                                                        ...
                                                                        <div className="card-block">
                                                                            <form id="main" method="post" action="/" novalidate="">
                                                                                <div className="form-group row">
                                                                                    <label className="col-sm-2 col-form-label">Floor Name</label>
                                                                                    <div className="col-sm-3">
                                                                                        <input type="text" className="form-control" id="oldFloorName"
                                                                                            placeholder="Floor Name" />
                                                                                        <span className="messages"></span>
                                                                                    </div>
                                                                                    <label className="col-sm-2 col-form-label">Description</label>
